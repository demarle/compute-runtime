...
set(current_ld_lib_path "$ENV{LD_LIBRARY_PATH}")
  ...
  if(NOT DEFINED cloc_cmd_prefix)
    if(WIN32)
      ...
      if(DEFINED NEO__IGC_LIBRARY_PATH)
        set(cloc_cmd_prefix LD_LIBRARY_PATH=${current_ld_lib_path}:${NEO__IGC_LIBRARY_PATH}:$<TARGET_FILE_DIR:ocloc_lib> $<TARGET_FILE:ocloc>)
      else()
        set(cloc_cmd_prefix LD_LIBRARY_PATH=${current_ld_lib_path}:$<TARGET_FILE_DIR:ocloc_lib> $<TARGET_FILE:ocloc>)
      endif()
    endif()
  endif()
